          ...
          <div className="space-y-8 max-w-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-8">
              <div className="space-y-4">
                <h3 className="font-helvetica font-light text-base text-primary">Contextual Design</h3>
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Architecture responding to environment and culture.
                </p>
              </div>
              <div className="space-y-4">
                <h3 className="font-helvetica font-light text-base text-primary">Sustainable Practice</h3>
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Ecological responsibility in every decision.
                </p>
              </div>
              <div className="space-y-4">
                <h3 className="font-helvetica font-light text-base text-primary">Cultural Continuity</h3>
                <p className="text-muted-foreground text-sm leading-relaxed">
